...
var paginationContainer = (exports.paginationContainer = function paginationContainer(
  query,
  connectionConfig
) {
  return function (Component) {
    return (0, _reactRelay.createPaginationContainer)(
      Component,
      query,
      connectionConfig
    );
...
var queryRenderer = (exports.queryRenderer = function queryRenderer(
  rootQuery,
  variables
) {
  return function (Component) {
    ...
    return (
      (_temp = _class = (function (_React$Component) {
        ...
        function RelayRoot() {
          ...
          return _possibleConstructorReturn(
            this,
            (RelayRoot.__proto__ || Object.getPrototypeOf(RelayRoot)).apply(
              this,
              arguments
            )
          );
      ...
      (_class.displayName = "RelayRoot(" + Component.displayName + ")"),
      _temp
    );
  };
});

var fragmentContainer = (exports.fragmentContainer = function fragmentContainer(
  query
) {
  return function (Component) {
    return (0, _reactRelay.createFragmentContainer)(function (props) {
...
var refetchContainer = (exports.refetchContainer = function refetchContainer(
  renderVariables,
  query
) {
  return function (Component) {
    return (0, _reactRelay.createRefetchContainer)(
      Component,
      renderVariables,
      query
    );
...
var createMutation = (exports.createMutation = function createMutation(
  mutation,
  config
) {
...
var createSubscription = (exports.createSubscription = function createSubscription(
  subscription,
  variables,
  config
) {
  return new Promise(function (res, rej) {
    ...
    (0, _reactRelay.requestSubscription)(
      environment,
      _extends(
        {
